...
const WIDGET_SRC =
  "https://tpembd.com/content?trs=513393&shmarker=713621.oludeniz&powered_by=true&country=109&city=549169&lang=en&width=100&background=transparent&logo=false&header=false&gearbox=false&cars=false&border=false&footer=false&campaign_id=87&promo_id=4322";

const FALLBACK_URL = "https://www.localrent.com/en/turkey/oludeniz/?marker=713621.oludeniz";
const FALLBACK_LABEL = "Or browse all Oludeniz rentals on Localrent →";
      ...
      <div className="container max-w-3xl mx-auto">
        <div className="bg-background rounded-lg p-6 text-center border border-border shadow-sm">
          <div className="flex items-center justify-center gap-3 mb-3">
            ...
            <h3 className="text-lg font-bold m-0">Search &amp; Compare Oludeniz Car Rentals</h3>
          </div>
          <div
            ref={containerRef}
