    ...
    <Layout>
      ...
      <Section alt>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-700 mt-4 leading-relaxed">
            A preauthorisation block is standard at Dalaman Airport, and the amount usually ranges from about <strong>&euro;120</strong> for a <strong>Kia Picanto</strong> or <strong>Renault Clio</strong> to <strong>&euro;250 or more</strong> for a <strong>Volkswagen Passat</strong>, <strong>Ford Focus</strong>, or <strong>Nissan Qashqai</strong>. Banks may take <strong>7&ndash;14 business days</strong> to release the funds after return, so a zero excess or full coverage upgrade can be useful if you want to reduce the blocked amount, but some packages still exclude tyres, glass, underbody damage, or lost keys. For a full breakdown of every coverage type, see our <Link to="/rental-tips-insurance" className="text-primary underline hover:text-accent">insurance and rental tips guide</Link>.
          </p>
        </div>
      </Section>
      ...
      <Section alt>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-700 leading-relaxed">
            Rain can make the asphalt slippery after long dry periods, because oil and dust collect on the surface and reduce grip when the first showers arrive. <strong>Yandex Navigasyon</strong> and <strong>Waze</strong> are useful for mobile speed-camera alerts, and the Turkish Traffic Police can be reached by dialling <strong>155</strong> in an emergency. Check our <Link to="/parking-fuel-guide" className="text-primary underline hover:text-accent">fuel stations and parking guide</Link> so you know where to refuel after a late arrival. For airport arrivals that finish after dark, a meet-and-greet or name sign pickup is often easier than trying to locate an off-airport desk in the terminal area.
          </p>
        </div>
      </Section>
